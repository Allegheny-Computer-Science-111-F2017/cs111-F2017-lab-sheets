...
our program and the {\tt NumericalCalculator} furnishes the methods that perform the required computations. If you want
...
computation, then you must make changes to the {\tt NumericalCalculator}. Overall, these two Java classes complete their
...
NumericalCalculator.java} file. To complete this task, you should directly copy the pattern that you see in the
...
``calculate'' methods in the {\tt NumericalCalculator}. You should also notice that all of the methods return a {\tt
