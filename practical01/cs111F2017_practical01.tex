...
% TODO: This is not correct --- there was no need to write a markdown file in this assignment!

To practice using GitHub to access the files for a practical assignment. Additionally, to practice using the Ubuntu
...
explore how to perform character output and to use escaped characters.
