...
instructor. Next, you will learn more about random number generation and the use of {\tt java.util.Random}, further
discovering how the course's automated grading tool assesses your progress towards correctly completing the project.
Finally, you will continue to learn more about creating and using Java classes and objects.
...
declaring and variables and reading from files, you should review Chapters 1 and 2 and Sections 3.1 and 3.2 in the
textbook.

% ensuring that you fully understand all of the concepts that we discussed during class and investigated during
% the prior practical and laboratory sessions. Please see the course instructor or one of the teaching assistants if you
...
``Allegheny-Computer-Science-111-Fall-2017/computer-science-111-fall-2017-practical-4-gkapfham''. Unless you provide the
...
Figure~\ref{mad} contains the output from running a program like the one you must implement. To gain some inspiration
and to learn more about Mad Libs and how your program should behave, please visit the site
\url{http://www.madlibs.com/}. After finishing the \mainprogramsource{} file, you should repeatedly test you program to
make sure that it is creating the correct textual output. This will involve you editing the input file so that it
contains different words and numbers in it and then running your program to determine if it correctly displays the
story.

\begin{figure}[tb]
\begin{Verbatim}[commandchars=\\\{\}]
Gregory M. Kapfhammer Fri Sep 29 12:01:06 EDT 2017
...
\item {\bf Experiment.} Practical sessions are for learning by doing without the pressure of grades or ``right/wrong''
  answers. So try things! To learn about files and variables, please intelligently experiment with the code, making small
