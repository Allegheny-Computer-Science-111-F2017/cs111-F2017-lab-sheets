...
declaring and variables and reading from files, you should review Chapters 1 through 3 and Sections 4.1 and 4.2 in the
textbook.
...
\item {\bf Experiment.} Practical sessions are for learning by doing without the pressure of letter grades. So try
  things! To learn more about classes and objects, please intelligently experiment with the code, making small
