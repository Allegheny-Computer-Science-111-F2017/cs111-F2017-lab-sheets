...
\newcommand{\assignmentassignedate}{August 7}
...
When you are finished typing text Java code in \program{gvim}, press the ESC key located in the upper left corner of the
...
\gitaddfile{src/main/java/labtwo/ComputeMoonDistance.java} in your terminal. Then you can type \command{git commit -a -m "Type
your own message"}, followed by typing \gitpush{} and see that the transfer to GitHub is successful. If you notice that
the network communication with GitHub did not work correctly, then please try to determine why, asking an assistant or
the instructor for assistance, if necessary.
...
Please note that at the time this assignment was released, the Travis CI servers were not available for testing and thus
you will not immediately be able to observe the \checkmark{} or \naughtmark{} in your commit listing on GitHub. Once
this service again becomes available, you will be able to complete this step of the assignment. Please see the
instructor if you have questions about this issue.
