...
final line outputting the result of a computation with variables. Please see the source code for more details!
...
your terminal window. Now, you are ready to learn to use new tools that build and run your program and check its
correctness!
