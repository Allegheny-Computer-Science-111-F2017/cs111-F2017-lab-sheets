...
took place during each of these replacements? Make sure that you fully understand the meaning of each row in the table.
Of course, you may talk with the course instructor or a teaching assistant or post a question in our Slack team if you
find these examples of DNA manipulation to be difficult to understand.
...
\item Print the complement of {\tt dnaString}, appropriately labeled.  (Hint: use several applications of the String
  ...
  {\tt String} variable {\tt dnaString}, then I will say {\tt dnaString.replace(`A',`T')}. But there's still another step to
