...
are replacing, for example, \emph{A}'s to \emph{T}'s from the $S$ to make our complementary sequence
...
{\tt Random} class in the textbook to understand the concepts behind the {\tt Random} class better; you may also ask
your instructor for help with this Java class.
