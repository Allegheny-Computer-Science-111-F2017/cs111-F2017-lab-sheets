...
\begin{itemize}
  ...
  \item The ways in which arrays can store both primitive variables and objects
...
\begin{itemize}
  ...
  \item The ability to trace the execution of a recursive method using a call graph
