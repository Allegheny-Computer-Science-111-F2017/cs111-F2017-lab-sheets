...
\newcommand{\secondprogramsource}{\lstinline{src/main/java/practicalten/InvestigateRecursiveSum.java}}
...
writing about the Java source code you can started with the use of GatorGrader,
type the command \gatorgraderstart{} in your terminal window. Once this step
