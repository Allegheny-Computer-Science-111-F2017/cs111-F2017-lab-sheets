...
computer graphics, you should review Chapters 1 and 2 and Sections 3.1 and 3.2 in the textbook, ensuring that you fully
understand all of the concepts that we discussed during class and investigated during prior practical and laboratory
sessions. Please see the instructor or one of the teaching assistants if you have questions these reading assignments.
...
After finishing the \mainprogramsource{} file, you should repeatedly test you program to make sure that it is creating
the correct textual output. This will involve you editing the input file so that it contains different words and numbers
in it and the running your program to determine if it correctly displays the story.
...
will need to review GatorGrader's output, find the mistake, and try to fix it.
