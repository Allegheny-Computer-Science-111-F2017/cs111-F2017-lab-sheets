...
The GatorGrader tool that you will learn to use in this laboratory assignment makes it easy for you to ensure that all
of your deliverables meet the standards for correctness. For instance, GatorGrader will check to ensure that
\mainprogram{} produces exactly four lines of output and that you use the \command{new Date()} construct in the Java
source code.
