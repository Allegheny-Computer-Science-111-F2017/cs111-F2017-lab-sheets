...
sure to keep a record of all of the steps that you complete and the challenges that you face. You may see the course
...
\begin{enumerate}
  ...
  \item If you do not already have a GitHub account, then please go to the GitHub web site and create one, making sure
    ...
    username is taken, you should also pick your GitHub username to be the same as Allegheny's Google email account.
    Now, in the \channel{#labs} channel of our Slack team, please type your full name, \command{allegheny.edu} email
  ...
  \item If you have never done so before, you must use the \command{ssh-keygen} program to create secure-shell keys that
    ...
    program that is known as a terminal. To run it, on the left side of your screen, click on the icon that contains the
    \command{>} symbol. Alternatively, you can type the ``Super'' key, start typing the word ``terminal'', and then
...
\section*{Evaluating Your Laboratory Assignment}
