...
% Edit this command to give the name to the main program

\newcommand{\mainprogram}[1]{\lstinline{DisplayOutput}}
\newcommand{\mainprogramsource}[1]{\lstinline{DisplayOutput.java}}

% Commands to describe key development tasks

\newcommand{\gatorgraderstart}[1]{\command{./gatorgrader --start}}
\newcommand{\gatorgradercheck}[1]{\command{./gatorgrader --check}}
\newcommand{\gradlebuild}[1]{\command{gradle build}}
\newcommand{\gradlerun}[1]{\command{gradle run}}

% Commands to describe key git tasks

\newcommand{\gitcommit}[1]{\command{git commit}}
\newcommand{\gitpush}[1]{\command{git push}}
\newcommand{\gitpull}[1]{\command{git push}}

% Use commands to describe key deliverables

\newcommand{\reflection}[1]{\command{writing/reflection.md}}
...
To get started with the use of GatorGrader, type the command \gatorgraderstart{} in your terminal window. If your
one or more of deliverables do not meet all of the assignment's requirements, then you will see the following output in
your terminal: \command{Overall, are there any mistakes in the assignment? Yes}. If you do have mistakes in your
assignment, then you will need to review GatorGrader's output, find the mistake, and try to fix it. Once your program is
compiling correctly and correctly fulfilling at least some of the assignment's requirements, you should transfer your
files to GitHub using the \gitcommit{} and \gitpush{} commands.




% TODO: Explain the steps for committing and pushing the code.
