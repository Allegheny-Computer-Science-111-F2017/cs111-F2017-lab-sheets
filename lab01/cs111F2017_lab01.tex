...
This laboratory assignment invites you to implement a Java program that displays four lines of output. The first line of
output should display your name and then today's date. The next three lines should each display some words of advice
that you want to share with the person running your program. You can accomplish the first task by typing
\command{System.out.println("Gregory M. Kapfhammer " + new Date());}, substituting your name for the name of the course
instructor. When you are finished typing text in \program{gvim}, press the ESC key located in the upper left corner of
...
your file, you can press \command{:w} when you are not in insert mode.
