...
\begin{enumerate}
  ...
  \item If you do not already have a GitHub account, then please go to the GitHub web site and create one, making sure
    ...
    account. Now, in the \channel{#labs} channel of our Slack team, please type your full name, \command{allegheny.edu}
    email address, and your new GitHub username. If you have already typed this information into Slack during a prior
  ...
  \item Since this is your first laboratory assignment and you are still learning how to use the appropriate software,
    ...
    assistants, and the course instructor. Remember, you can use Slack to talk with the instructor by using
...
code for this assignment. For instance, if the course instructor ran the \command{git clone} command it the terminal, it
would look like:
...
a neighbor or a teaching assistant.
...
\gitcommit{} command to transfer your source code to your GitHub repository, Travis CI will initialize a \step{build} of
your assignment, checking to see if it meets all of the requirements. If both your source code and writing meet all of
the established requirements, then you will see a green \checkmark{} in the listing of commits in GitHub. If your
...
and writing, as further described in \step{Evaluation} section of this assignment sheet. Unless you provide the
...
\noindent Students do not need to submit printed source code or technical writing for any assignment. Instead, this
assignment invites you to submit, using GitHub, the following deliverables.
...
instructor will reduce your grade for the assignment while still consider the regularity with which you committed to
