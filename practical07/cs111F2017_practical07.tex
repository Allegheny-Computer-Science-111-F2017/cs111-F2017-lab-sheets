...
\newcommand{\mainprogramsource}{\lstinline{src/main/java/practicalsix/PasswordCheckerMain.java}}

\newcommand{\secondprogram}{\lstinline{PasswordChecker}}
\newcommand{\secondprogramsource}{\lstinline{src/main/java/practicalsix/PasswordChecker.java}}
...
\newcommand{\gitcommitmainprogram}{\command{git commit src/main/java/practicalsix/PasswordCheckerMain.java -m "Your
...
PasswordCheckerMain.java}, determine which of the following events occurs that year: \begin{itemize}
