...
shapes. For this task you will use {\tt for} loops. Finally, you will continue to learn more about how to perform file
input and output and create console output using the {\tt println} statement.
...
Java objects and writing conditional logic, you should review Chapters 1 through 5 and Sections 6.1 through 6.4 in the
textbook.
