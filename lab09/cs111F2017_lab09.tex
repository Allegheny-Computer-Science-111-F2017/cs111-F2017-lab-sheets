...
\newcommand{\gitaddmainprogram}{\command{git add src/main/java/labeight/TodoListManager.java}}
...
% As always, please refer to the \readme{} file in your repository for all of the requirements associated with these
% files.
...
that match the requested category. Again using the aforementioned example todo list, this operation would also return
the first two tasks. The {\tt markTaskAsDone} method, as shown below, gives a concrete example of how to iterate through
