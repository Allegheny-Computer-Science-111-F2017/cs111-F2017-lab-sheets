...
In conclusions, here are some points to remember as you complete this laboratory assignment:
...
\item The provided source code uses the {\tt Scanner} class; notice that it is imported at the top of the program. You
  ...
  variables may cause the program to crash to produce incorrect output. See the instructor or an assistant if you are
