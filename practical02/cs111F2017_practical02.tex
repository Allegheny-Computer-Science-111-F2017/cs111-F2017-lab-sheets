...
of output that your program should produce. Note that the provided source code contains defects in it! You are
responsible for finding and fixing all of these defects. Once you locate and resolve 
