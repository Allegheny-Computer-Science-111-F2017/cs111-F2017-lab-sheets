...
with the teaching assistants and the course instructor. Next, you will learn how
to fix a Java program, further discovering how the course's automated grading
tool assesses your progress towards correctly completing the project. Finally,
you will continue to learn more about variables and data types and the errors
that may arise when variables have the wrong types.
