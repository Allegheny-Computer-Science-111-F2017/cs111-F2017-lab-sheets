...
\newcommand{\mainprogramsource}{\lstinline{src/main/java/labone/ComputeMoonDistance.java}}
...
\newcommand{\gitcommitmainprogram}{\command{git commit src/main/java/lab/ComputeMoonDistance.java -m "Your
...
the Ubuntu operator system and software development programs such as a ``terminal window'' and the ``GVim text editor''.
...
``Allegheny-Computer-Science-111-Fall-2017/computer-science-111-fall-2017-practical-1-gkapfham''. Unless you provide the
instructor with documentation of the extenuating circumstances that you are facing, not accepting the assignment means
that you automatically receive a failing grade for it. Please follow the steps from the two previous laboratory
assignments for finding your ``home base'' for this practical assignment; see the instructor if you are stuck on getting
started.
...
{\tt println} statements you can use to produce the output.
...
correctly, then please try to determine why, asking an assistant or the
