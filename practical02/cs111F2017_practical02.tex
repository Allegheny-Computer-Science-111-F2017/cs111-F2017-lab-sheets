...
\newcommand{\mainprogramsource}{\lstinline{src/main/java/labone/DisplayArtwork.java}}
...
\newcommand{\gitcommitmainprogram}{\command{git commit src/main/java/lab/DisplayArtwork.java -m "Your
...
\section*{Display Character-Based Artwork}
...
like
``Allegheny-Computer-Science-111-Fall-2017/computer-science-111-fall-2017-practical-1-gkapfham''.
Unless you provide the instructor with documentation of the extenuating
circumstances that you are facing, not accepting the assignment means that you
automatically receive a failing grade for it. Please follow the steps from the
two previous laboratory assignments for finding your ``home base'' for this
