...
for you to automatically check if your submission meets the standards for correctness.
...
GitHub is successful. Remember, to correctly complete this assignment you need to commit all Java source code to GitHub.
If you notice that the network communication with GitHub did not work correctly, then please try to determine why,
asking a teaching assistant or the instructor for assistance.
