...
\newcommand{\mainprogramsource}{\lstinline{src/main/java/labthree/DisplayGraphicalScene.java}}
...
\newcommand{\gitaddmainprogram}{\command{git add src/main/java/labthree/DisplayGraphicalScene.java}}
\newcommand{\gitcommitmainprogram}{\command{git commit src/main/java/labthree/DisplayGraphicalScene.java -m "Your
...
src/main/java/labthree/DisplayGraphicalScene.java} in your terminal window. This should cause a new window, the \program{gvim}
