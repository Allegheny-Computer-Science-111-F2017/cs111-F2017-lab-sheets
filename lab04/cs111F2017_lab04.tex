...
the program was run. You can accomplish the first task by typing \command{System.out.println("Gregory M. Kapfhammer " +
new Date());}, substituting your name for the name of the course instructor. Please see the Java source code comments
for more details about the program's purpose! The remainder of this section summarizes the goals for this program.
