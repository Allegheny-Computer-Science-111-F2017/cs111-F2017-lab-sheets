...
\newcommand{\secondprogramsource}{\lstinline{src/main/java/labfour/PaintGraphicalScene.java}}
...
should also review Chapter 1 and study Chapter 2 in the course textbook, paying close attention to Sections 2.7 through
2.9 and Figures 2.9, 2.10, and 2.12. See the instructor if you have questions these reading assignments.
...
This assignment invites you to implement desktop wallpaper art similar to the ones that are found on the web site called
\url{http://simpledesktops.com/}. First, your Java program should output line should display your name and then today's
date. You can accomplish the first task by typing \command{System.out.println("Gregory M. Kapfhammer " + new Date());},
substituting your name for the name of the course instructor. Please see the Java source code comments for more details!
The remainder of this section summarizes the purpose of the new program.
...
\item Contain at least four single-line comments and two multi-line comments
\item Declare and use the \command{CANVAS_HEIGHT} variable
% \item Declare and use the `CANVAS_WIDTH` variable
% \item Create at least five colors using the `page.setColor` method call
% \item Create at least three rectangles using the `fillRect` method call
% \item Create at least five ovals using the `fillOval` method call
% \item Declare and use at least two `int` variable when creating graphics
...
\item See Figure 2.10 for a listing of some common \command{Color} variables.
